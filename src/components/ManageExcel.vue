  ...
  export default {
    ...
    setup() {
      ...
      const columnDefs = reactive({
        value: [
                 { editable:true, maxWidth: 300,field: "name1", headerName: 'Фамилия' },
                 { editable:true, maxWidth: 200,field: "name2", headerName: 'Имя' },
                 { editable:true, maxWidth: 230,field: "name3", headerName: 'Отчество'},  //hide: true
    ...
    methods: {
      ...
      async loadGroupsData() {
          try {
            const response = await UserService.getTempData(); // Replace with your API endpoint
