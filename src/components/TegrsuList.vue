<template>
    ...
    <div class="col col-xs-9 col-lg-12 mt-4 list">
      ...
      <div class="mb-3 col col-12">
        ...
        <button @click="navigateToAddTegrsu" class="btn btn-primary float-start" type="button"><i class="material-icons-outlined">add</i>Назначить предмет</button>
    ...
    setup() {
      ...
      const columnDefs = reactive({
        ...
        maxWidth: 120, resizable: false
              ...
              { field: "teacher_id", headerName: 'id',hide:true },
