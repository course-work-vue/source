    ...
    methods: {
      ...
      async addGroup(lgroup) {
        try {
          ...
          const response = await UserService.addLgroup(lgroup.group_number,lgroup.group_program_id,lgroup.hours,lgroup.start_date,lgroup.end_date,lgroup.StartTime,lgroup.EndTime); 
          response.data;
          this.loading=false;
